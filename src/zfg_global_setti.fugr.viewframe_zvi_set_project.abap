*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVI_SET_PROJECT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVI_SET_PROJECT     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVI_SET_PROJECT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVI_SET_PROJECT_EXTRACT
TOTAL = ZVI_SET_PROJECT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVI_SET_PROJECT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVI_SET_PROJECT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_SET_PROJECT_EXTRACT
TOTAL = ZVI_SET_PROJECT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVI_SET_PROJECT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVI_SET_PROJECT'
...
TOTAL = ZVI_SET_PROJECT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVI_SET_PROJECT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVI_SET_PROJECT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVI_SET_PROJECT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVI_SET_PROJECT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_SET_PROJECT_EXTRACT
TOTAL = ZVI_SET_PROJECT_TOTAL
