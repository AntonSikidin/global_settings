*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVI_SET_DESCRIPT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVI_SET_DESCRIPT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVI_SET_DESCRIPT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVI_SET_DESCRIPT_EXTRACT
TOTAL = ZVI_SET_DESCRIPT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVI_SET_DESCRIPT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVI_SET_DESCRIPT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_SET_DESCRIPT_EXTRACT
TOTAL = ZVI_SET_DESCRIPT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVI_SET_DESCRIPT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVI_SET_DESCRIPT'
...
TOTAL = ZVI_SET_DESCRIPT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVI_SET_DESCRIPT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVI_SET_DESCRIPT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVI_SET_DESCRIPT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVI_SET_DESCRIPT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_SET_DESCRIPT_EXTRACT
TOTAL = ZVI_SET_DESCRIPT_TOTAL
